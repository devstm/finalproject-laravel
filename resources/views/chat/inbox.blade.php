    ...
    <div class="modal-content" style="max-width: 1000px ;margin-right: 30px ">
        <div class="kt-portlet__body kt-portlet__body--fit" style="text-align: center; background-color: #ff2800">
            <div class="kt-widget17">
                <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides" style="background-color: #ff2800">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            transform="translate(11.959697, 3.661508) rotate(-90.000000) translate(-11.959697, -3.661508) "/>
                            ...
                            <a href="{{route('message.index')}}"><span class="kt-widget17__subtitle" style="font-size: 30px">
																الرسائل المرسله
															</span>
                        ...
                        <div class="kt-chat__messages kt-chat__messages--solid">
                            ...
                            <div class="kt-chat__message kt-chat__message--success">
                                <div class="kt-chat__user">
                                    ...
                                    <a href="#" class="kt-chat__username" style="font-size: 30px"><span>{{ optional(auth('craftsman')->user())->name }} </span></a>
                                    <span class="kt-chat__datetime" style="font-size: 30px">المستقبل:{{ $message->getSenderName() }}</span>
