...
<div class="kt-login__signup">
    ...
    <form class="kt-login__form kt-form" method="POST" action="{{ route('login') }}">
        @csrf
        ...
        <div>
            <center><a href="{{ route('password.request') }}"  class="kt-link kt-link--light kt-login__account-link">{{ __('craftsman.forgotPassword') }}</a></center>
        </div>
...
<div>
    ...
    <a href="{{ route('register') }}"  class="kt-link kt-link--light kt-login__account-link">{{ __('craftsman.register') }}</a>
</div>
@endsection