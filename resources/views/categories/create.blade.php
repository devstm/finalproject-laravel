            ...
            <form class="kt-form kt-form--label-right" action="{{ route('category.store') }}" method="post">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" placeholder="اسم الفئة" id="example-text-input" autocomplete autofocus>
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control @error('describe') is-invalid @enderror" type="text" name="describe" placeholder="وصف الفئة" id="describe" autocomplete>
                            @error('describe')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
